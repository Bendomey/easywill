            ...
            <div className="flex-1 px-4 flex justify-between">
              ...
              <div className="ml-4 flex items-center md:ml-6">
                ...
                <div className="ml-3 relative">
                  ...
                  {showMenu && (
                    <Fragment>
                      <div classNameName="origin-top-right absolute right-0 mt-2 w-48 rounded-md shadow-lg">
                        <div
                          classNameName="py-1 rounded-md bg-white shadow-xs"
                          role="menu"
                        ...
                        >
                          <a
                            href="#"
                            classNameName="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 transition ease-in-out duration-150"
                            role="menuitem"
                          >
                            Your Profile
                          </a>
